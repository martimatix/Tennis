...
#[test]
fn test_score_0_0() {
    let tennis_match = tennis::Match::new("player 1", "player 2");
    assert_eq!(tennis_match.score(), "0-0");
}

#[test]
fn test_score_15_15() {
    let mut tennis_match = tennis::Match::new("player 1", "player 2");
    tennis_match.point_won_by("player 1");
    tennis_match.point_won_by("player 2");
